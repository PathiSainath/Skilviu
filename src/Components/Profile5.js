    ...
    <div className="bg-gray-50 text-gray-800 font-sans">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-col items-center">
          ...
          >
            Mrs. Naveena excels in building and maintaining strong customer relationships. Her vast
            experience in customer relations ensures that our clients receive the highest level of
