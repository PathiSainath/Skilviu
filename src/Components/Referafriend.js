...
//       if (formData.candidate_name && formData.candidate_name.length >= 2) {
//         try {
...
//   }, [formData.candidate_name, jobId, jobFromState]);
...
//     const friendKey = `${formData.friend_name.toLowerCase()}-${formData.friend_contact}`;
...
//         // Add friend to referred list
//         setReferredFriends(prev => [...prev, friendKey]);
        
//         setMessage({ 
//           type: 'success', 
//           text: `${formData.friend_name} referred successfully! You can refer more friends to this job.` 
//         });
...
//         // Auto-clear success message after 3 seconds to allow next referral
...
//         {/* Show referred friends count */}
//         {referredFriends.length > 0 && (
//           <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
//             <h3 className="text-sm font-semibold text-blue-800 mb-2">
//               Friends Already Referred to this Job: {referredFriends.length}
//             </h3>
//             <p className="text-xs text-blue-600">
//               You can continue referring more friends to the same job!
//             </p>
//           </div>
//         )}
...
//             {showCandidateDropdown && candidateSearchResults.length > 0 && (
...
//             <button
//               type="submit"
//               disabled={loading || !jobDetails?.success || !candidateDetails}
//               className={`font-semibold px-6 py-3 rounded-lg shadow transition ${
//                 loading || !jobDetails?.success || !candidateDetails
//                   ? 'bg-gray-400 cursor-not-allowed'
//                   : 'bg-indigo-600 hover:bg-indigo-700 text-white'
//               }`}
//             >
//               {loading ? 'Submitting...' : 'Refer This Friend'}
//             </button>
