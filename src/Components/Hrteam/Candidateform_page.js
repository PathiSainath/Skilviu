...
//           ].map(({ label, name, type, maxLength, required }) => (
...
//               Accepted format: PDF (maximum file size: 2MB).
//             </p>
//           </div>
...
//                   value="yes"
//                   checked={formData.hasPreferredCompany === 'yes'}
//                   onChange={() =>
//                     setFormData((prev) => ({
//                       ...prev,
//                       hasPreferredCompany: 'yes',
//                     }))
//                   }
...
//                   name="hasPreferredCompany"
//                   value="no"
//                   checked={formData.hasPreferredCompany === 'no'}
//                   onChange={() =>
//                     setFormData((prev) => ({
//                       ...prev,
//                       hasPreferredCompany: 'no',
//                       preferredCompany: '',
//                     }))
//                   }
//                   className="text-indigo-600 focus:ring-indigo-500"
...
// export default Candidateform_page;
