...
//     } else if (!formData.website.startsWith('https://www.')) {
//       newErrors.website = 'Website must start with https://www.';
//     }
...
//     const displayOnlyFields = ['contact_Name2', 'Designation2', 'contact_Email2', 'contact_Mobile2'];
//     const keysToSend = Object.keys(formData).filter(key => !displayOnlyFields.includes(key));
...
//     if (slaFile) data.append('sla_document', slaFile);

//     try {
//       const res = await fetch('https://skilviu.com/backend/api/v1/clientforms', {
//         method: 'POST',
//         body: data,
//       });
...
//       focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition ${errors.website ? 'border-red-500' : 'border-gray-300'
//                   }`}
//               />
//               {errors.website && (
...
//           <button
//             type="submit"
//             className="bg-blue-600 hover:bg-blue-700 transition font-semibold rounded-xl px-10 py-3 shadow-lg text-white focus:outline-none focus:ring-4 focus:ring-blue-400"
//           >
//             Submit
//           </button>
//         </div>
