    ...
    <aside className="h-full bg-white shadow p-6 flex flex-col justify-between">
      <div>
        ...
        <nav className="space-y-4 text-sm">
          ...
          {/* <NavLink to="/admindashboard/clientform-page" className={navItemClass}>
            <ClipboardList className="mr-2 w-4 h-4" />
            CO FORM
          </NavLink>
          <NavLink to="/admindashboard/recruitment-page" className={navItemClass}>
            <FileSignature className="mr-2 w-4 h-4" />
            CR FORM
          </NavLink> */}
          {/* <NavLink to="/admindashboard/candidateform-page" className={navItemClass}>
