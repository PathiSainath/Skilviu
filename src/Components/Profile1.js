    ...
    <div className="bg-gray-50 text-gray-800 font-sans">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-col items-center">
          ...
          >
            Mr. Naveen Kumar Indla is the visionary leader of Skilviu Soft Solutions, with over 10 years
            of industry experience. His dynamic leadership and innovative thinking drive the company
